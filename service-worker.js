const CACHE_NAME = 'cache-v6'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v6',
    'estilos/styles.css?v6',
    'estilos/mediaQueries.css?v6',
    'javascript/script.js?v6',
